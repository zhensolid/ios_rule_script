...
本项目的iOS系统升级分流规则由爬虫程序自动维护。

定时爬取互联网上开源的iOS系统升级分流规则，将其进行清洗、去重、合并、优化后，形成单一的分流规则文件，旨在解决引用大量外部规则造成规则重复的问题。
...
欢迎通过[issues](https://github.com/blackmatrix7/ios_rule_script/issues/new)提交反馈，共同完善本项目的iOS系统升级分流规则。
